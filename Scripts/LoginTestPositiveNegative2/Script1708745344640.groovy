...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_password'), 'BfgbC29pA3w=')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Login'))

WebUI.verifyTextPresent('Login failed! Please ensure the username and password are valid.', false, FailureHandling.CONTINUE_ON_FAILURE)
